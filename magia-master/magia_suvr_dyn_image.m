function suvr_image_file = magia_suvr_dyn_image(start_time,end_time,input,frames,pet_filename,brainmask,outputdir)
...
suvr = magia_suvr_dyn(input,tacs,frames,start_time,end_time);
