...
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.quality = 1;  % highest accuracy
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.sep = 2; %
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.fwhm = fwhm; 
matlabbatch{1}.spm.spatial.realign.estwrite.eoptions.rtm = rtm; % realign to mean
